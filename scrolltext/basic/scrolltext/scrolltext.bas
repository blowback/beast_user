...
80 S = 60000
90 FOR I = 0 TO 4: READ V: POKE S+I, V: NEXT I
120 REM
...
490 GOTO 310
500 REM
510 REM --- MBB_WRITE_LED stub: LD A,E / CALL &HFDD6 / RET ---
515 DATA &H7B, &HCD, &HD6, &HFD, &HC9
517 REM
520 REM --- Font DATA (ASCII 32-126, 95 entries) ---
